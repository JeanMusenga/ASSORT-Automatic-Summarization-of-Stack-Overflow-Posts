...
- The participants are first provided with a screenshot of the Stack Overflow question.
 [![running](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/question.png "running")](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/question.png "running")
 
- The participants are asked to report their expertise on the topic after carefully reading the question.
 [![running](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/expertise.png "running")](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/expertise.png "running")
 
- The participants are asked to read an answer under the specific question.
 [![running](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/answer.png "running")](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/answer.png=250x "running")
 
- The participants are shown with summaries generated by three models (with sequence of summaries shuffled).
 [![running](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/summaries.png "running")](https://github.com/BonanKou/ASSORT-Automatic-Summarization-of-Stack-Overflow-Posts/blob/main/screenshots/summaries.png=250x "running")
